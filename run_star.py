...
if __name__ == '__main__':
    ...
    dispatch_star(
        bam_map_kellis_429, vcf_map_kellis_429, bed_map_kellis_429, genome_path, boundaries_path, whitelist_path, out_path_base_kellis_429, 80000, selection=fail_kellis_429
    )
